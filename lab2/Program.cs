...
namespace visual_programming
{
    class Program{
        static void Main(string[] args) {
            ...
            Console.WriteLine("331 = " + b1.ToString());
            Console.WriteLine("152 = " + b2.ToString());
            Console.WriteLine("Arabian \t\t|\tRoman");
            Console.WriteLine("331 + 152 =  483 \t|\t" + b1.ToString() + " + " + b2.ToString() + " = " + RomanNumber.Add(b1, b2));
            Console.WriteLine("331 - 152 =  179 \t|\t" + b1.ToString() + " - " + b2.ToString() + " = " + RomanNumber.Sub(b1, b2));
            t1 = ((ushort)25);
            b1 = new RomanNumber(t1);
            t2 = ((ushort)5);
            b2 = new RomanNumber(t2);
            Console.WriteLine("25 * 5 = 125 \t\t|\t" + b1.ToString() + " * " + b2.ToString() + " = " + RomanNumber.Mul(b1, b2));
            Console.WriteLine("25 / 5 = 5 \t\t|\t" + b1.ToString() + " / " + b2.ToString() + " = " + RomanNumber.Div(b1, b2));
